...
//   v_peak(water_bend)         = WATER_BEND_AMPLITUDE         × WATER_BEND_OMEGA         = 0.18
//   v_peak(water_asym_stretch) = WATER_ASYM_STRETCH_AMPLITUDE × WATER_ASYM_STRETCH_OMEGA = 0.42
//
...
// Water modes peak at 0.4 (stretch), 0.18 (bend), and 0.42 (asym stretch),
// all ≤ 0.5, so they share oscillating's c minimum.
